...
namespace DVLD.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if(_Driver == null)
            {
             MessageBox.Show("No Driver Found for this Driver ID", "Not Found", MessageBoxButtons.OK, MessageBoxIcon.Information);
             return;
            }   
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
             MessageBox.Show("No Driver Found for this Person ID", "Not Found", MessageBoxButtons.OK, MessageBoxIcon.Information);
